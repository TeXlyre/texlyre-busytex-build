...
\* LLVM localize-globals in WASM objects (\[bug 51279](https://bugs.llvm.org/show\_bug.cgi?id=51279))
...
\* Static Perl embedding for `fmtutil.pl`, `updmap.pl` (\[perlembed](https://perldoc.perl.org/perlembed), \[extending/embedding guide](http://www.kaiyuanba.cn/content/develop/Perl/Extending\_And\_Embedding\_Perl.pdf))
