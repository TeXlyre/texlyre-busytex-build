...
```
src/              C sources (busytex.c, packfs.c, kpse\_remote.c, headers)
web/              Browser runtime (busytex\_pipeline.js, busytex\_worker.js)
tools/            Build-time helpers invoked by the Makefile
cli/              User-facing runners (busytexmk.py, build\_arxiv.\*)
